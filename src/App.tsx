      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: você pode utilizar a variável <code className='text-violet-400'>{'{transcription}'}</code> no seu prompt para adionar o conteúdo da transcrição do vídeo selecionado.</p>
        </div>
          ...
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea
                ...
                placeholder="Inclua palavras-chave mencionadas no vídeo separads por vírgula (,)"
              />
            </div>
